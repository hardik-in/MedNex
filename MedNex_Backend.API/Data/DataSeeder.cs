...
namespace MedNex_Backend.API.Data
{
    public class DataSeeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            // NOTE: PublicId is auto-assigned by DbContext.ApplyAuditRules on insert.
            ...
            var doctorSeeds = new[]
            {
                new { First = "Rajesh",  Last = "Kumar",  Email = "rajesh.kumar@mednex.com",  Phone = "+919876500001", Spec = "Cardiology",       License = "LIC-CAR-001", Qual = "MBBS, MD Cardiology",       Bio = "Senior cardiologist with 15 years of experience.",   Fee = 800m,  CareerStart = new DateTime(2008, 6, 1),  DOB = new DateTime(1978, 3, 20),  Gender = Gender.Male   },
                new { First = "Priya",   Last = "Sharma", Email = "priya.sharma@mednex.com",   Phone = "+919876500002", Spec = "Neurology",        License = "LIC-NEU-001", Qual = "MBBS, DM Neurology",        Bio = "Specialist in neurological disorders and headaches.", Fee = 900m,  CareerStart = new DateTime(2011, 3, 1),  DOB = new DateTime(1981, 7, 10),  Gender = Gender.Female },
                new { First = "Anil",    Last = "Mehta",  Email = "anil.mehta@mednex.com",     Phone = "+919876500003", Spec = "Orthopedics",      License = "LIC-ORT-001", Qual = "MBBS, MS Orthopedics",      Bio = "Expert in bone and joint surgery.",                  Fee = 700m,  CareerStart = new DateTime(2013, 9, 1),  DOB = new DateTime(1983, 11, 5),  Gender = Gender.Male   },
                new { First = "Sneha",   Last = "Patel",  Email = "sneha.patel@mednex.com",    Phone = "+919876500004", Spec = "Dermatology",      License = "LIC-DER-001", Qual = "MBBS, MD Dermatology",      Bio = "Specialist in skin and hair conditions.",            Fee = 600m,  CareerStart = new DateTime(2015, 1, 1),  DOB = new DateTime(1985, 5, 22),  Gender = Gender.Female },
                new { First = "Vikram",  Last = "Singh",  Email = "vikram.singh@mednex.com",   Phone = "+919876500005", Spec = "General Medicine", License = "LIC-GEN-001", Qual = "MBBS, MD General Medicine", Bio = "General physician with broad clinical expertise.",   Fee = 500m,  CareerStart = new DateTime(2017, 4, 1),  DOB = new DateTime(1988, 9, 14),  Gender = Gender.Male   },
            };
            ...
            for (int i = 0; i < doctorSeeds.Length; i++)
            {
                ...
                var doctorUser = new User
                {
                    ...
                    IsActive = true,
                    ReferenceId = ReferenceIdGenerator.Generate("USR", year, i + 2)
                };
            ...
            for (int i = 0; i < patientSeeds.Length; i++)
            {
                ...
                var patientUser = new User
                {
                    ...
                    IsActive = true,
                    ReferenceId = ReferenceIdGenerator.Generate("USR", year, i + 7)
                };
